...
"padding-bottom:7px;")
        ...
        self.widget_2.setGeometry(QtCore.QRect(250, 40, 241, 361))
        self.widget_2.setObjectName("widget_2")
        self.register_2 = QtWidgets.QLabel(self.widget_2)
        self.register_2.setGeometry(QtCore.QRect(60, 30, 121, 40))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
...
"padding-bottom:7px;")
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(30, 300, 190, 40))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(0, 30, 30, 40))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
